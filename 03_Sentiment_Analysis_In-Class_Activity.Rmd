...
- Step 3: Convert the sentiment to numeric 
...
```
#### load the wordcloud library to create wordclouds 
- Use comparison.cloud to create two wrodclouds in a single wordcloud. 

```{r comparison clouds}

# tm package functions to get the term frequencies. 
# TermDocumentMatrix()
...
airbnb_reviews_processed$sentiment_polarity <- scale(airbnb_reviews_processed$sentiment_polarity)
```
